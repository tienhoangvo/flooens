...
const creatSendToken = (statusCode, user, req, res) => {
...
exports.signup = exports.createUser = catchAsync(async (req, res, next) => {
  const {
    name,
    email,
    password,
  ...
  creatSendToken(201, newUser, req, res);
});
...
exports.login = catchAsync(async (req, res, next) => {
  ...
  creatSendToken(200, user, req, res);
});
